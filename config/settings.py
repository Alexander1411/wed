...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-tr7mse69*lnk6f-z-$y(-rf01@z4&@5^vjofb-+9gp2sfri528",
)
...
# Manifest storage needs `collectstatic`; use plain storage locally so `runserver` works without that step.
if DEBUG:
